...
cursor.execute ('''
    CREATE TABLE IF NOT EXISTS products(
                ...
                componenets_id INT,
                FOREIGN KEY (componenets_id) REFERENCES components(id),
...
cursor.execute ('''
    CREATE TABLE IF NOT EXISTS orders(
                ...
                aproxematly_date_of_arrival DATE,
...
cursor.execute ('''
    CREATE TABLE IF NOT EXISTS supplier(
                ...
                FOREIGN KEY (supplier_license_type) REFERENCES license_type(id),
...
cursor.execute ('''
    CREATE TABLE IF NOT EXISTS customers(
                ...
                FOREIGN KEY (customer_license_type) REFERENCES license_type(id),
...
cursor.execute ('''
    CREATE TABLE IF NOT EXISTS carriers(
                ...
                suply_id INT,
                FOREIGN KEY (suply_id) REFERENCES suply(id),

                storage_id INT,
                FOREIGN KEY (storage_id) REFERENCES storage(id),

                carrier_license_type_id INT,
                FOREIGN KEY (carrier_license_type_id) REFERENCES license_type(id),
...
cursor.execute ('''
                ...
                storage_boss_id INT,
                FOREIGN KEY (storage_boss_id) REFERENCES carrier(id),
...
cursor.execute ('''
    CREATE TABLE IF NOT EXISTS directory of occupations (
                id INT AUTO_INCREMENT PRIMARY KEY,
...
cursor.execute ('''
    CREATE TABLE IF NOT EXISTS method of application (
                id INT AUTO_INCREMENT PRIMARY KEY,
...
cursor.execute ('''
    CREATE TABLE IF NOT EXISTS type of packaging (
                id INT AUTO_INCREMENT PRIMARY KEY,
...
cursor.execute ('''
    CREATE TABLE IF NOT EXISTS stage of sending (
                id INT AUTO_INCREMENT PRIMARY KEY,
...
cursor.execute ('''
    CREATE TABLE IF NOT EXISTS license_type PRIMARY KEY,
